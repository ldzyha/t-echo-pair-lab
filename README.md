...
4. [Калібрування BME280](docs/CALIBRATION.md) — виміри, формули, TH1–TH4, похибки; [TH5](docs/CALIBRATION-TH5.md) і [TH6](docs/CALIBRATION-TH6.md) — окремі гарячі поправки датчиків.
...
- [Контурні сердечка серією 2–5 натискань](docs/QUICK-HEART.md) основної кнопки — особисте повідомлення партнеру без меню.
- [Подія дотику та підсвітка на 30 секунд T-Echo Plus](docs/FRONTLIGHT-T1.md), із журналом перевірок та обмежень.
...
- [Останнє повідомлення без архіву переписки](docs/LATEST-STATE-L1.md), відновлення його телефону після підключення та справжній вік останньої GPS-точки.
