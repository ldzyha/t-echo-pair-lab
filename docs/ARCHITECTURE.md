...
7. Кожне повне API-підключення має власний курсор відтворення останнього вхідного повідомлення. Повтор до телефона не створює RX, RF-пакета, сповіщення на рації або нового часу отримання. Повідомлення, уже передане поточною API-чергою, пропускається під час відтворення.
...
Політика L1 і міграція попереднього сховища: [останній стан](LATEST-STATE-L1.md).
