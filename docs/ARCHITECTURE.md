...
7. Кожне повне API-підключення має власний курсор відтворення вхідної історії. Повтор до телефона не створює RX, RF-пакета, сповіщення на рації або нового часу отримання. Повідомлення, уже передане поточною API-чергою, пропускається під час відтворення.
